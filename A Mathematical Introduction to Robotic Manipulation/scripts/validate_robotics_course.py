"""Execute robotics course notebooks with nbclient."""
...
def notebook_paths(all_notebooks: bool, limit: int | None) -> list[Path]:
    ...
    if not all_notebooks:
        smoke_order = [
            ...
            "03-manipulator-kinematics.ipynb",
            "04-robot-dynamics-and-control.ipynb",
            "06-hand-dynamics-and-control.ipynb",
            "08-nonholonomic-motion-planning.ipynb",
            "09-future-prospects.ipynb",
            "appendix-b-a-mathematica-package-for-screw-calculus.ipynb",
        ]
