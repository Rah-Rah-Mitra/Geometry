"""Audit MFGDL notebook structure and standalone teaching density."""
...
def main() -> None:
    ...
    if args.json:
        ...
        print(f"Audited {report['summary']['chapter_count']} MFGDL chapter notebooks")
        if report["findings"]:
            for finding in report["findings"]:
                print(f"- {finding['check']} [{finding['path']}]: {finding['message']}")
        else:
            print("All MFGDL notebook checks passed.")
