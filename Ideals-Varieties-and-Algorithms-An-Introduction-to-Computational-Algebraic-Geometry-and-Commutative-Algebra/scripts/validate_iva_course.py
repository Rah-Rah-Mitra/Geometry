"""Execute IVA notebooks with nbclient."""
...
def notebook_paths(all_notebooks: bool, limit: int | None) -> list[Path]:
    ...
    if not all_notebooks:
        smoke_order = [
            "00-book-index.ipynb",
            "01-geometry-algebra-and-algorithms.ipynb",
            "02-grobner-bases.ipynb",
            "06-robotics-and-theorem-proving.ipynb",
            "08-projective-algebraic-geometry.ipynb",
            "09-dimension-of-a-variety.ipynb",
            "10-additional-grobner-basis-algorithms.ipynb",
            "appendix-b-pseudocode.ipynb",
            "appendix-c-computer-algebra-systems.ipynb",
        ]
        by_name = {path.name: path for path in paths}
        paths = [by_name[name] for name in smoke_order if name in by_name]
