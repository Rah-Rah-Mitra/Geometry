"""Execute contact topology notebooks with nbclient."""
...
SMOKE_NAMES = {
    "01-facets-of-contact-geometry.ipynb",
    "03-knots-in-contact-3-manifolds.ipynb",
    "04-contact-structures-on-3-manifolds.ipynb",
    "06-contact-surgery.ipynb",
    "appendix-b-time-dependent-vector-fields.ipynb",
}
