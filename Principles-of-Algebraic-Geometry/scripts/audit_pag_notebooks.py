...
BOOK_ROOT=Path(__file__).resolve().parents[1]; sys.path.insert(0,str(Path(__file__).resolve().parent)); import pag_inventory as inv
import nbformat
def main():
 f=[]; n=0
 ...
 print(json.dumps({'notebook_count':n,'findings':f},indent=2));
