...
BOOTSTRAP_MARKERS = [
    "The source unit is phrased in the language of **Discrete and Computational Geometry**",
    "Use the model above as a controlled experiment. Change one numerical parameter",
    "not merely around the general subject of Discrete and Computational Geometry",
    "curvature_proxy",
    "vandermonde",
