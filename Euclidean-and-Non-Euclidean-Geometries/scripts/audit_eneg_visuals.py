"""Audit ENEG visual artifacts and notebook display calls."""
...
VISUAL_SAVE_CALLS = {"save_matplotlib", "save_plotly_html", "save_relationship_map", "save_scene", "save_lab"}
GENERIC_ARTIFACT_NAMES = {"relationship-map.png", "geometric-scene.png", "applied-lab.png"}
...
def main() -> None:
    ...
    for topic in artifact_topics():
        ...
        for png in pngs:
            ...
            if png.name in GENERIC_ARTIFACT_NAMES:
                findings.append({"check": "generic-artifact-name", **item})
    ...
    if args.json:
        ...
        if findings:
            ...
            print("All ENEG visual audit checks passed.")
    if findings:
        raise SystemExit(1)
