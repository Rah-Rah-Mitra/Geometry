"""Audit Hartshorne Algebraic Geometry visual artifacts and artifact integrity."""
...
def main() -> None:
    ...
    for entry in inventory.ENTRIES:
        ...
        for png in pngs:
            ...
            if stats["size"] < 1024:
                failures.append(f"{png.relative_to(BOOK_ROOT)} is unexpectedly tiny: {stats['size']} bytes")
