"""Execute ACMG notebooks with nbclient."""
...
SMOKE_NAMES = {
    "00-book-index.ipynb",
    "01-metric-spaces.ipynb",
    "02-length-spaces.ipynb",
    "05-smooth-length-structures.ipynb",
    "07-space-of-metric-spaces.ipynb",
    "10-spaces-of-curvature-bounded-below.ipynb",
}
